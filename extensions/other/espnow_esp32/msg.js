...
function addMsg (Blockly) {
  Object.assign(Blockly.ScratchMsgs.locales.en, {
    ...
    ESPNOW_SET_PHY_RATE: 'set ESP-NOW PHY rate to %1',
    ESPNOW_PHY_RATE_1M: '1 Mbps (Normal)',
    ESPNOW_PHY_RATE_LR_500K: '500 kbps (LR)',
    ESPNOW_PHY_RATE_LR_250K: '250 kbps (LR)',
    ESPNOW_PHY_RATE_SET_SUCCESS: 'last ESP-NOW PHY rate setting succeeded',
  ...
  Object.assign(Blockly.ScratchMsgs.locales.ja, {
    ...
    ESPNOW_SET_PHY_RATE: 'ESP-NOWのPHYレートを %1 に設定する',
    ESPNOW_PHY_RATE_1M: '1 Mbps（Normal）',
    ESPNOW_PHY_RATE_LR_500K: '500 kbps（LR）',
    ESPNOW_PHY_RATE_LR_250K: '250 kbps（LR）',
    ESPNOW_PHY_RATE_SET_SUCCESS: 'ESP-NOWのPHYレート設定に成功した',
  ...
  Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
    ...
    ESPNOW_SET_PHY_RATE: '将ESP-NOW PHY速率设置为 %1',
    ESPNOW_PHY_RATE_1M: '1 Mbps（普通）',
    ESPNOW_PHY_RATE_LR_500K: '500 kbps（LR）',
    ESPNOW_PHY_RATE_LR_250K: '250 kbps（LR）',
    ESPNOW_PHY_RATE_SET_SUCCESS: 'ESP-NOW PHY速率设置成功',
